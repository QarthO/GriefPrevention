...
public class BoundaryVisualizationEvent extends PlayerEvent
{
    ...
    /**
     * Get the {@link Boundary Boundaries} to visualize. The collection is mutable,
     * addons may add or remove elements as they see fit.
     *
    ...
    /**
     * Get the {@link VisualizationProvider} used to create the
